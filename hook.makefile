...
x32 : $(SRC_FILE)
	...
	echo '.........................................'
	$(cc) -o $(OUT_DIR)/libloader_stage_one.so    $(debug)         -fPIC -m32 -O0 -nostartfiles -nodefaultlibs -nostdlib -I ./ loader_stage_one.c
...
x64 : $(SRC_FILE)
	...
	./$(OUT_DIR)/generate 1 $(OUT_DIR)/config.json
	echo '.........................................'
	$(cc) -o $(OUT_DIR)/libloader_stage_one.so    $(debug) -fPIC -m64 -O0 -nostartfiles -nodefaultlibs -nostdlib -I ./ loader_stage_one.c
